        ...
        <div className="container mx-auto max-w-7xl px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-in fade-in-left duration-700">
              <Image src="/assets/our-services/industrial-automation.png" alt="Industrial Automation" width={600} height={400} data-ai-hint="factory automation" className="rounded-lg shadow-lg grayscale hover:grayscale-0 focus:grayscale-0 transition-all duration-300" />
            </div>
